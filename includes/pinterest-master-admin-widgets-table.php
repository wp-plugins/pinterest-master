...
<table class="widefat fixed" cellspacing="0">
	...
	<tbody>
		<tr class="alternate">
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-pinterestmaster-admin-widget-buttons.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('pinterest_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
		...
		<tr>
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-pinterestmaster-admin-widget-board.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('pinterest_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
		...
		<tr class="alternate">
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-pinterestmaster-admin-widget-profile.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('pinterest_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
		...
		<tr>
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-pinterestmaster-admin-widget-top-pin.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('amazon_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
