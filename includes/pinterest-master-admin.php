...
<tr>
<td width="387">
<img src="<?php echo plugins_url('../images/techgasp-pinterestmaster-logo.png', __FILE__); ?>" alt="Pinterest Master" align="left" width="387px" height="171px" style="padding:5px;"/>
</td>
<td width="0,5"></td>
<td width="700">
...
<h2><?php _e("Pinterest Master LITE Version", 'pinterest_master'); ?></h2>
<br>
<form method="post" width='1'>
<fieldset class="options">
<legend><h3><img src="<?php echo plugins_url('../images/techgasp-minilogo-16.png', __FILE__); ?>" style="float:left; height:16px; vertical-align:middle;" /><?php _e('&nbsp;Advanced Version Updater:', 'pinterest_master'); ?></h3></legend>
<br>
<div class="description">Only available in <b>Pinterest Master Advanced Version</b>.</div>
</fieldset>
...
<div class="description">All <b>LITE</b> widget options are available in your widgets page. <b>Pinterest Master Widget</b>.</div>
...
<div class="description">The shortcode framework allows you to insert Pinterest Master inside Pages & Posts without the need of extra plugins or gimmicks. Fast page load times and top SEO. Only available in <b>Pinterest Master Advanced Version</b>.</div>
<br>
<div style="background: url(<?php echo plugins_url('../images/techgasp-hr.png', __FILE__); ?>) repeat-x; height: 10px"></div>

<h3><img src="<?php echo plugins_url('../images/techgasp-minilogo.png', __FILE__); ?>" style="width:40px; vertical-align:middle;" alt="' . esc_attr__( 'TechGasp Plugins') . '" /> Pinterest Master Website</h3>
<p><a class="button-secondary" href="http://wordpress.techgasp.com/pinterest-master/" target="_blank" title="Pinterest Master Info Page">Info Page</a> <a class="button-secondary" href="http://wordpress.techgasp.com/pinterest-master-documentation/" target="_blank" title="Pinterest Master Documentation">Documentation</a> <a class="button-primary" href="http://wordpress.techgasp.com/pinterest-master/" target="_blank" title="Pinterest Master Advanced Version">Advanced Version</a></p>
</form>
</div>