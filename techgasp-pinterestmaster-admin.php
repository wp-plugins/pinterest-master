<div class="wrap">
<div class="icon32" style="width:40px; vertical-align:middle;"><img src="../wp-content/plugins/pinterest-master/techgasp-minilogo.png" alt="' . esc_attr__( 'TechGasp Plugins') . '" /><br /></div>

<h2><b>TechGasp - Pinterest Master Advanced Version</b></h2>
<form method="post" action="techgasp-pinterestmaster-admin.php"> 
...
<img src="../wp-content/plugins/pinterest-master/techgasp-pinterestmaster-logo.png" alt="Pinterest Master" align="left" width="387px" height="171px" style="padding:5px;"/>
<p><h2>Pinterest Master:</h2></p>
<p>Pinterest Master adds the follow me on pinterest, pin it button, show pinterest profile and show pinterest board to your wordpress website.</p>
</br>
<p><em>pin it for wordpress...</em><p>
</br>
</br>
<p><h3>Options & Configuration:</h3></p>
<p><b>All configuration options are available in your widgets page. Pinterest Master Widget:</b></p>
<p>Select or <em>"add"</em > Pinterest Master Widget. Configure your settings. Select widget position according to your template. That easy...</p>
<p><b>Insert Pinterest Master Widget inside Pages and Posts (advanced version only):</b></p>
<p>Copy and Paste this shortcode inside your pages or posts [pinterestmaster id=xx] replace xx with your sidebar number, ie [pinterestmaster id=sidebar-1]</p>
<p><a class="button-primary" href="widgets.php" title="Widgets Page">To Widgets Page</a> <a class="button-secondary" href="http://wordpress.techgasp.com/pinterest-master/" target="_blank" title="More Help">More Help</a> <a class="button-primary" href="http://wordpress.techgasp.com/pinterest-master/" target="_blank" title="Pinterest Master Advanced Version">Pinterest Master Advanced Version</a></p>
<hr>
<p><h3>Pinterest Master Advanced Version</h3></p>
<p>Lite version contains Follow Me Button.</p>
<p>Advanced version contains Pin it Button, Follow Me Button, Display Pinterest Board, Display Pinterest Profile.</p>
